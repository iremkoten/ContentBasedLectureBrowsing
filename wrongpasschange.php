...
<body style="background-color:#ffffff;">
 ...
 <div id='d1' style="position:absolute; top:0px; left:0px; z-index:1"> 
    ...
    <label style="font-family: arial" for="usr">Active User: <?php session_start(); echo $_SESSION["activeuser"]; $servername = "";
$username = "";
$password = "";
$dbname = "";
...
while($row=$result->fetch_assoc()) {
	...
	<div id='d9' style="position:absolute; top:200px; left:30%; z-index:1"> 
    <label style="font-family: arial">Password:</label>
    <input type="password" id="pwd" name="pwd" minlength="8" required>
    </div>
	
	<div id='d9' style="position:absolute; top:230px; left:30%; z-index:1"> 
    <label style="font-family: arial">Password:</label>
    <input type="password" id="pwd2" name="pwd2" minlength="8" required>
    </div>
	
	<div id='d8' style="position:absolute; top:260px; left:30%; z-index:1"> 
		<input type="submit" value="Change Password">
		 </div>
	</form>
	
	<div id='d8' style="position:absolute; top:290px; left:30%; z-index:1"> 
		 <label style="font-family: arial">Password doesnt match</label>
		 </div>
